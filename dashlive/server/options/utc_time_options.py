...
from .dash_option import IntOrNoneDashOption, StringListDashOption, StringOrNoneDashOption
from .types import OptionUsage

ClockDrift = IntOrNoneDashOption(
...
UTCMethod = StringOrNoneDashOption(
...
UTCValue = StringOrNoneDashOption(
    usage=(OptionUsage.MANIFEST | OptionUsage.TIME),
    short_name='utv',
    full_name='utcValue',
    title='UTC value',
...
NTPSources = StringListDashOption(
    usage=OptionUsage.MANIFEST,
    short_name='ntps',
